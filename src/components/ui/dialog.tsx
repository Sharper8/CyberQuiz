...
>(({ className, children, ...props }, ref) => {
  ...
  const hasTitle = childrenArray.some((c) => {
    return (
      ...
      (c.type === DialogPrimitive.Title || (c.type as any)?.displayName === DialogPrimitive.Title.displayName || (c.type as any)?.displayName === 'DialogTitle')
    );
  });
  ...
  const hasDescription = childrenArray.some((c) => {
    return (
      React.isValidElement(c) &&
      (c.type === DialogPrimitive.Description || (c.type as any)?.displayName === DialogPrimitive.Description.displayName || (c.type as any)?.displayName === 'DialogDescription')
    );
  });
