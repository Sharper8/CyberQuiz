      ...
      >
        <div
          style={{
            ...
            inset: 0,
            backgroundImage:
              "linear-gradient(rgba(163,230,53,0.10) 1px, transparent 1px), linear-gradient(90deg, rgba(34,211,238,0.10) 1px, transparent 1px)",
            backgroundSize: "56px 56px",
            opacity: 0.9,
            maskImage:
              "radial-gradient(circle at 40% 40%, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 70%)",
          }}
        />
